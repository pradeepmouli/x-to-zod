...
describe('ReferenceBuilder', () => {
  it('generates direct reference for named import', () => {
    ...
    const builder = new ReferenceBuilder('UserSchema', 'UserSchema', importInfo);
  ...
  it('supports lazy references via z.lazy', () => {
    ...
    const builder = new ReferenceBuilder('CommentSchema', 'CommentSchema', importInfo, true);
    const text = builder.text();
  ...
  it('applies modifiers (optional, nullable, readonly, default, describe, brand)', () => {
    ...
    const builder = new ReferenceBuilder('EntitySchema', 'EntitySchema', importInfo)
      .optional()
      .nullable()
      .readonly()
      .default({ a: 1 })
  ...
  it('captures type-only flag without affecting emitted code', () => {
    ...
    const builder = new ReferenceBuilder('TypeOnlySchema', 'TypeOnlySchema', importInfo);
    const text = builder.text();
