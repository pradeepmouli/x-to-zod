...
describe('SourceFileGenerator', () => {
  ...
  describe('generateFile', () => {
    it('should generate a TypeScript file with builder code', () => {
      ...
      imports.addImport({ importName: 'z4', importKind: 'default', modulePath: 'zod' });

      const sourceFile = generator.generateFile('user', builder, imports, 'UserSchema');
    ...
    it('should include import statements in generated file', () => {
      ...
      const imports = new ImportManager('esm');
      imports.addImport({ importName: 'z4', importKind: 'default', modulePath: 'zod' });
      imports.addImport({ importName: 'PostSchema', importKind: 'default', modulePath: './post.js' });

      const sourceFile = generator.generateFile('entity', builder, imports, 'EntitySchema');
    ...
    it('should place imports before export statement', () => {
      const builder = new MockBuilder('z4.object({ value: z4.number() })') as unknown as ZodBuilder;
      const imports = new ImportManager('esm');
      imports.addImport({ importName: 'z4', importKind: 'default', modulePath: 'zod' });
      imports.addImport({ importName: 'BaseSchema', importKind: 'default', modulePath: './base.js' });

      const sourceFile = generator.generateFile('derived', builder, imports, 'DerivedSchema');
    ...
    it('should handle multiple import statements', () => {
      ...
      const imports = new ImportManager('esm');
      imports.addImport({ importName: 'z4', importKind: 'default', modulePath: 'zod' });
      imports.addImport({ importName: 'UserSchema', importKind: 'default', modulePath: './user.js' });
      imports.addImport({ importName: 'PostSchema', importKind: 'default', modulePath: './post.js' });
      imports.addImport({ importName: 'CommentSchema', importKind: 'default', modulePath: './comment.js' });

      const sourceFile = generator.generateFile('feed', builder, imports, 'FeedSchema');
    ...
    it('should handle schema IDs with slashes', () => {
      const builder = new MockBuilder('z4.object({ id: z4.string() })') as unknown as ZodBuilder;
      const imports = new ImportManager('esm');
      imports.addImport({ importName: 'z4', importKind: 'default', modulePath: 'zod' });

      const sourceFile = generator.generateFile('api/v1/user', builder, imports, 'ApiUserSchema');
    ...
    it('should return null on error', () => {
      ...
      const sourceFile = generator.generateFile('invalid', null as any, imports, 'InvalidSchema');
  ...
  describe('generateIndex', () => {
    it('should generate index file with exports', () => {
      const entries: SchemaEntry[] = [
        { id: 'user', exportName: 'UserSchema', schema: {}, builder: null, sourceFile: null, metadata: {} },
        { id: 'post', exportName: 'PostSchema', schema: {}, builder: null, sourceFile: null, metadata: {} },
        { id: 'comment', exportName: 'CommentSchema', schema: {}, builder: null, sourceFile: null, metadata: {} },
      ];
      const imports = new ImportManager('esm');
      ...
      expect(text).toContain('export { default as CommentSchema } from "./comment"');
    });

    it('should handle nested schema paths', () => {
      const entries: SchemaEntry[] = [
        { id: 'api/v1/user', exportName: 'ApiV1UserSchema', schema: {}, builder: null, sourceFile: null, metadata: {} },
        { id: 'models/user', exportName: 'ModelsUserSchema', schema: {}, builder: null, sourceFile: null, metadata: {} },
      ];
      const imports = new ImportManager('esm');
      ...
      const text = sourceFile?.getFullText();
      expect(text).toContain('export { default as ApiV1UserSchema } from "./api/v1/user"');
      expect(text).toContain('export { default as ModelsUserSchema } from "./models/user"');
    });
  ...
  describe('saveAll', () => {
    ...
    it('should return errors if save fails', async () => {
      ...
      const badGenerator = new SourceFileGenerator('/nonexistent/path/that/does/not/exist', false);
    ...
    it('should format files when prettier is enabled', async () => {
      ...
      generatorWithPrettier.generateFile('formatted', builder, imports, 'FormattedSchema');
  ...
  describe('formatting', () => {
    it('should properly format generated code', () => {
      ...
      const sourceFile = generator.generateFile('nested', builder, imports, 'NestedSchema');
  ...
  describe('file path computation', () => {
    it('should compute correct relative paths for schema IDs', () => {
      ...
      const sf1 = generator.generateFile('models/user', builder, imports, 'UserSchema');
      const sf2 = generator.generateFile('schemas/post', builder, imports, 'PostSchema');
  ...
  describe('integration', () => {
    it('should generate complete project structure', async () => {
      ...
      userImports.addImport({ importName: 'z4', importKind: 'default', modulePath: 'zod' });

      const postImports = new ImportManager('esm');
      postImports.addImport({ importName: 'z4', importKind: 'default', modulePath: 'zod' });
