...
describe('SchemaRegistry', () => {
  ...
  describe('addEntry', () => {
    ...
    it('should throw error when adding duplicate ID', () => {
      registry.addEntry(testEntry);
      expect(() => registry.addEntry(testEntry)).toThrow('already exists in registry');
    });
  ...
  describe('getEntry', () => {
    ...
    it('should retrieve correct entry among multiple', () => {
      const entry1: SchemaEntry = { ...testEntry, id: 'user', exportName: 'User' };
      const entry2: SchemaEntry = { ...testEntry, id: 'post', exportName: 'Post' };
  ...
  describe('updateEntry', () => {
    it('should throw error when updating non-existent entry', () => {
      expect(() => registry.updateEntry('nonexistent', { exportName: 'New' }))
  ...
  describe('integration', () => {
    it('should handle complex workflow', () => {
      // Add entries
      const userEntry: SchemaEntry = { ...testEntry, id: 'user', exportName: 'User' };
      const postEntry: SchemaEntry = { ...testEntry, id: 'post', exportName: 'Post' };
      const commentEntry: SchemaEntry = { ...testEntry, id: 'comment', exportName: 'Comment' };
