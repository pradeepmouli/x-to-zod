...
/**
 * Build a Zod object schema string from JSON schema object constraints.
 * Handles properties, additionalProperties, patternProperties, and combinators.
 *
 * Note: This function requires parseSchema and combinator parsers for delegation,
 * so it accepts them as parameters to avoid circular dependencies.
 */
export function buildObject(
  objectSchema: JsonSchemaObject & { type: "object" },
  refs: Refs,
  parseSchema: (schema: any, refs: Refs) => string,
  parseAnyOf: (schema: any, refs: Refs) => string,
  parseOneOf: (schema: any, refs: Refs) => string,
  parseAllOf: (schema: any, refs: Refs) => string,
  its: any,
): string {
