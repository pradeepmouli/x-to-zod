...
const coreBuilders = {
	number: (
		paramsOrOptions?:
			| Parameters<typeof import('zod').z.number>[0]
		...
		const isOptions =
			...
			('zodVersion' in paramsOrOptions ||
				'seen' in paramsOrOptions ||
				'path' in paramsOrOptions);
		return isOptions
			? new NumberBuilder(
					undefined,
					paramsOrOptions as import('../Types.js').Options,
				)
			: new NumberBuilder(
					paramsOrOptions as Parameters<typeof import('zod').z.number>[0],
					options,
				);
	},
	string: (
		paramsOrOptions?:
			| Parameters<typeof import('zod').z.string>[0]
			| import('../Types.js').Options,
		options?: import('../Types.js').Options,
	) => {
		const isOptions =
		...
		return isOptions
			...
			: new StringBuilder(
					paramsOrOptions as Parameters<typeof import('zod').z.string>[0],
					options,
				);
	},
	boolean: (
		paramsOrOptions?:
			| Parameters<typeof import('zod').z.boolean>[0]
			| import('../Types.js').Options,
		options?: import('../Types.js').Options,
	) => {
		const isOptions =
		...
		return isOptions
			...
			: new BooleanBuilder(
					paramsOrOptions as Parameters<typeof import('zod').z.boolean>[0],
					options,
				);
	},
	...
	array: (
		itemSchemaZod:
			...
			| import('./BaseBuilder.js').ZodBuilder[],
		paramsOrOptions?:
			| Parameters<typeof import('zod').z.array>[1]
			| import('../Types.js').Options,
		options?: import('../Types.js').Options,
	) => {
		const isOptions =
		...
		return isOptions
			...
			: new ArrayBuilder(
					itemSchemaZod,
					paramsOrOptions as Parameters<typeof import('zod').z.array>[1],
					options,
				);
	},
	object: (
		...
		paramsOrOptions?:
			| Parameters<typeof import('zod').z.object>[1]
			| import('../Types.js').Options,
		options?: import('../Types.js').Options,
	) => {
		const isOptions =
		...
		return isOptions
			...
			: new ObjectBuilder(
					properties,
					paramsOrOptions as Parameters<typeof import('zod').z.object>[1],
					options,
				);
	},
	enum: (
	...
	date: (
		paramsOrOptions?:
			| Parameters<typeof import('zod').z.date>[0]
			| import('../Types.js').Options,
		options?: import('../Types.js').Options,
	) => {
		const isOptions =
		...
		return isOptions
			...
			: new DateBuilder(
					paramsOrOptions as Parameters<typeof import('zod').z.date>[0],
					options,
				);
	},
	bigint: (
		paramsOrOptions?:
			| Parameters<typeof import('zod').z.bigint>[0]
			| import('../Types.js').Options,
		options?: import('../Types.js').Options,
	) => {
		const isOptions =
		...
		return isOptions
			...
			: new BigIntBuilder(
					paramsOrOptions as Parameters<typeof import('zod').z.bigint>[0],
					options,
				);
	},
