...
```ts
constructor(version: "v3" | "v4", params?: TimeParams): TimeBuilder
```
**Properties:**
- `typeKind: "time"`
...
- `_params: [params?: TimeParams]` (optional)
- `_optional: boolean`
- `_nullable: boolean`
- `_readonly: boolean`
...
**Methods:**
- `withPrecision(precision: number): this` — Set precision for time validation (millisecond precision).
