...
```ts
constructor(version: "v3" | "v4", params?: string | { normalize?: boolean; pattern?: RegExp; abort?: boolean; hostname?: RegExp; protocol?: RegExp; error?: string | $ZodErrorMap<NonNullable<$ZodIssueInvalidStringFormat | $ZodIssueInvalidType<unknown>>>; message?: string }): UrlBuilder
```
**Properties:**
- `typeKind: "url"`
...
- `_params: [params?: string | { normalize?: boolean; pattern?: RegExp; abort?: boolean; hostname?: RegExp; protocol?: RegExp; error?: string | $ZodErrorMap<NonNullable<$ZodIssueInvalidStringFormat | $ZodIssueInvalidType<unknown>>>; message?: string }]` (optional)
- `_optional: boolean`
- `_nullable: boolean`
- `_readonly: boolean`
