...
*extends `StringFormatBuilder<ZodStringFormat<"duration">, [params?: DurationParams]>`*
*implements `BuilderFor<ZodStringFormat<"duration">>`*
```ts
constructor(version: "v3" | "v4", params?: DurationParams): DurationBuilder
```
**Properties:**
- `typeKind: "duration"`
...
- `_params: [params?: DurationParams]` (optional)
- `_optional: boolean`
- `_nullable: boolean`
- `_readonly: boolean`
