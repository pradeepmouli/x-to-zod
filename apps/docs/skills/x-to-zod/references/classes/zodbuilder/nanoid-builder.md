...
*extends `StringFormatBuilder<ZodNanoID, [params?: Parameters<typeof z.nanoid>[0]]>`*
*implements `BuilderFor<ZodNanoID>`*
```ts
constructor(version: "v3" | "v4", params?: string | { pattern?: RegExp; abort?: boolean; error?: string | $ZodErrorMap<NonNullable<$ZodIssueInvalidStringFormat | $ZodIssueInvalidType<unknown>>>; message?: string }): NanoidBuilder
```
**Properties:**
- `typeKind: "nanoid"`
...
- `_params: [params?: string | { pattern?: RegExp; abort?: boolean; error?: string | $ZodErrorMap<NonNullable<$ZodIssueInvalidStringFormat | $ZodIssueInvalidType<unknown>>>; message?: string }]` (optional)
- `_optional: boolean`
- `_nullable: boolean`
- `_readonly: boolean`
