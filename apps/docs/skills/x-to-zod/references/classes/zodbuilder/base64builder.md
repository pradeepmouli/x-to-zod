...
*extends `StringFormatBuilder<ZodBase64, [params?: Parameters<typeof z.base64>[0]]>`*
*implements `BuilderFor<ZodBase64>`*
```ts
constructor(version: "v3" | "v4", params?: string | { abort?: boolean; error?: string | $ZodErrorMap<NonNullable<$ZodIssueInvalidStringFormat | $ZodIssueInvalidType<unknown>>>; message?: string }): Base64Builder
```
**Properties:**
- `typeKind: "base64"`
...
- `_params: [params?: string | { abort?: boolean; error?: string | $ZodErrorMap<NonNullable<$ZodIssueInvalidStringFormat | $ZodIssueInvalidType<unknown>>>; message?: string }]` (optional)
- `_optional: boolean`
- `_nullable: boolean`
- `_readonly: boolean`
